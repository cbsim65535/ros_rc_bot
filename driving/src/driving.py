...
class RcBot:
    ...
    REVERSE_DRIVING_MIN_PULSE = 1050

    ACCEL_SIZE_PER_ONE = (ESC_MAX_PULSE - DRIVING_MIN_PULSE) * 0.15
    ACCEL_STEP = 10
    
    REVERSE_ACCEL_SIZE_PER_ONE = (REVERSE_DRIVING_MIN_PULSE - ESC_MIN_PULSE) * 0.7
