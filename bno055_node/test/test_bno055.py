...
if __name__ == '__main__':
	bno = BNO055(address=BNO055.BNO055_ADDRESS_B)
	...
	while True:
		print(bno.getVector(BNO055.VECTOR_ACCELEROMETER),bno.getVector(BNO055.VECTOR_MAGNETOMETER),bno.getVector(BNO055.VECTOR_GYROSCOPE),bno.getVector(BNO055.VECTOR_EULER),bno.getVector(BNO055.VECTOR_LINEARACCEL),bno.getVector(BNO055.VECTOR_GRAVITY))
		time.sleep(0.01)